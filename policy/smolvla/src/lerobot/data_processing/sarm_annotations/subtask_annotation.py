...
def save_annotations_to_dataset(
    ...
    from UniVTAC.policy.smolvla.src.lerobot.datasets import DEFAULT_EPISODES_PATH, load_episodes
...
def load_annotations_from_dataset(dataset_path: Path, prefix: str = "sparse") -> dict[int, SubtaskAnnotation]:
    ...
    from UniVTAC.policy.smolvla.src.lerobot.datasets import load_episodes
